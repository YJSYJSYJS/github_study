...
- commit: 세이브, 스테이지 영역의 파일들로 커밋(= save)을 할 수 있다.
- push: 원격 저장소에 커밋을 업로드 한다.

## 커밋(Commit)

- 게임의 세이브와 유사(언제든지 세이브 포인트로 돌아갈 수 있다.)
- 저장을 원하는 파일들을 묶어서 커밋 명령 수행

## 스테이지에 올리기(Add)

- 저장을 원하는 파일들을 커밋하기 전에 묶는 명령
...
- 장점: 쉬워요.
- 단점1: 커밋이 날아간다.
- 단점2: 강제푸쉬가 필요하다. -> 소스트리에서는 강제푸시를 지원하지않는다.
